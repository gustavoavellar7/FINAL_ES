...
**
** Created: Sat Nov 16 02:31:20 2013
...
static const char qt_meta_stringdata_SecondWindow[] = {
    "SecondWindow\0"
};
...
const QMetaObjectExtraData SecondWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject SecondWindow::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SecondWindow,
      qt_meta_data_SecondWindow, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &SecondWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SecondWindow))
