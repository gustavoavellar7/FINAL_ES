...
**
** Created: Sat Nov 16 15:44:44 2013
...
static const char qt_meta_stringdata_Connection[] = {
    "Connection\0\0,\0newMessage(Connection*,QString)\0"
    "connected(Connection*,QString)\0"
    "disconnected(Connection*,QString)\0"
    "recv()\0sendMessage(QString)\0disconnect()\0"
};
...
void Connection::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newMessage((*reinterpret_cast< Connection*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->connected((*reinterpret_cast< Connection*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 2: _t->disconnected((*reinterpret_cast< Connection*(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
...
// SIGNAL 0
void Connection::newMessage(Connection * _t1, QString _t2)
{
...
// SIGNAL 1
void Connection::connected(Connection * _t1, QString _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
...
// SIGNAL 2
void Connection::disconnected(Connection * _t1, QString _t2)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)), const_cast<void*>(reinterpret_cast<const void*>(&_t2)) };
